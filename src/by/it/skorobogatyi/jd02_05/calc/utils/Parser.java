...
public class Parser {
    ...
    private AbstractVar calcOneOperation(String leftStr, String operation, String rightStr) throws CalcException {
        ...
        if (left == null || right == null) {
            String message = String.format("%s" + leftStr + operation + rightStr, lang.get("error.incorrectOperation"));
        ...
        switch (operation) {
            ...
            default:
                String message = String.format("%s", lang.get("error.incorrectExpression"));
                throw new CalcException(message);
        }
    }
